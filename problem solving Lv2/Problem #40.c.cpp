...
bool isNumberinarry(int Number, int arr[100], int arrLength)
{
...
void copyDistinctNumbers(int arrSource[100], int arrDestination[100], int SourceLength, int& DestinationLength)
{
	...
	{
		if (!isNumberinarry(arrSource[i], arrDestination, DestinationLength))
		{
...
int main()
{
	int arrSource[100], SourceLength = 0, DestinationLength = 0, arrDestination[100];
